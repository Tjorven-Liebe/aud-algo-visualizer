...
export const ALGORITHM_DATA = {
  quicksort: {
    name: "QuickSort (CLRS Lomuto & Hoare Partitioning)",
    category: "sort",
    isTestat: false,
    file: "QuickSort.java",
    code: [
      ...
      "        if (p < r) {",
      "            int q = partition(arr, p, r); // Sub-Methode Partitionierung",
      "            quickSort(arr, p, q);         // Rekursion links",
      "            quickSort(arr, q + 1, r);     // Rekursion rechts",
      "        }",
      "    }",
      "",
      "    public int partition(int[] arr, int p, int r) {",
      "        int pivot = arr[p]; // Pivotelement an Index p (Hoare)",
      "        int i = p - 1, j = r + 1;",
      "        while (true) {",
      "            do { i++; } while (arr[i] < pivot);",
      "            do { j--; } while (arr[j] > pivot);",
      "            if (i < j) {",
      "                swap(arr, i, j); // Sub-Methode Tausch",
      "            } else {",
      "                return j; // Trennindex q",
      "            }",
      "        }",
      "    }",
      "",
  ...
  hybridsort: {
    name: "HybridSort (Praktikumsaufgabe Blatt 1)",
    category: "sort",
    isTestat: true,
    file: "HybridSort.java",
    code: [
      "public class HybridSort {",
      "    private int k; // Tiefe-Schwellenwert",
      "",
      "    public void hybridSort(int[] arr, int p, int r, int depth) {",
      "        if (p >= r) return;",
      "        if (depth >= this.k) {",
      "            mergeSort(arr, p, r); // Sub-Methode MergeSort bei Tiefe k",
      "            return;",
      "        }",
      "        int q = partition(arr, p, r); // Sub-Methode Partition",
      "        hybridSort(arr, p, q, depth + 1);",
      "        hybridSort(arr, q + 1, r, depth + 1);",
      "    }",
      "",
      "    public int partition(int[] arr, int p, int r) {",
      "        int pivot = arr[p];",
      ...
      "            mergeSort(arr, l, m);",
      "            mergeSort(arr, m + 1, r);",
      "            merge(arr, l, m, r); // Sub-Methode Merge",
      "        }",
      "    }",
      "",
  ...
  mergesort: {
    ...
    code: [
      ...
      "            mergeSort(arr, l, m);",
      "            mergeSort(arr, m + 1, r);",
      "            merge(arr, l, m, r); // Sub-Methode Mischen",
      "        }",
      "    }",
      "",
  ...
  heapsort: {
    ...
    code: [
      ...
      "        for (int i = n - 1; i > 0; i--) {",
      "            swap(arr, 0, i); // Wurzel tauschen",
      "            maxHeapify(arr, i, 0); // Heap-Eigenschaft wiederherstellen",
      "        }",
      "    }",
      "",
